...
public class PackageOL extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String fileName = "Demo"+PackageNow_Linux.environmentNames[environment]+"_"+dateFormat.format(new Date(System.currentTimeMillis())).concat(".apk");//DemoStaging_20160508_16h03m.apk
